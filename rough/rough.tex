...
\begin{figure}[h!]
	\centering
	\subfloat[A Roomba 560]{\includegraphics[width=0.3\textwidth, angle=270]{images/roomba_own}}
	~
	\subfloat[A Samsung Galaxy S II]{\includegraphics[width=0.3\textwidth, angle=270]{images/galaxy}}
	~
	\subfloat[An XBOX 360 controller]{\includegraphics[width=0.3\textwidth, angle=180]{images/xbox_own}}
...
\begin{figure}
	\centering
	\subfloat[Mario Circuit, as seen in the video game ``Mario Kart Wii". Courtesy of http://smashbros.com\cite{mario_color}.]{\includegraphics[width=0.3\textwidth]{images/mario_circuit_screenshot}}
	~
	\subfloat[The original floor plan for the course used in the study. It was later scaled to be appropriate for the size of the Roomba and the lab space in which the experiment took place. Courtesy of Super Mario Wiki\cite{mario_bw}.]{\includegraphics[width=0.3\textwidth]{images/MarioCircuitLayout}}
...
\makebox{\includegraphics[page=1, width=0.9\textwidth]{Questionnaire.pdf}}
...
\makebox{\includegraphics[page=1, width=\textwidth]{modification-approval.pdf}}

\includepdf[pages=1-last, pagecommand={\thispagestyle{myheadings} \markright{}}, noautoscale=true, width=\textwidth]{irb-modified.pdf}


\includepdf[pages=-, pagecommand={\thispagestyle{myheadings} \markright{}}, noautoscale=true, width=1.1\textwidth]{consent_form.pdf}
\end{document}